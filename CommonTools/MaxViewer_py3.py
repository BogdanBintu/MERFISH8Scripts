...
class imshow_mark_3d:
    def __init__(self,ims,ims_c=[],fig=None,image_names=None,rescz=1.,min_max_default = [None,None],save_file=None,normalize=False):
        """
        ...
        if self.normalize:
            self.im_ = np.array([im__/np.mean(im__) for im__ in self.im_])
